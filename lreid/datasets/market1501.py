...
class IncrementalSamples4market(IncrementalPersonReIDSamples):
    ...
    def __init__(self, datasets_root, relabel=True, combineall=False):
        ...
        train = self.process_dir(self.train_dir, relabel=True) # [img_path, pid, camid, 'market1501', pid]
        query = self.process_dir(self.query_dir, relabel=False) # [img_path, pid, camid, 'market1501', pid]
        gallery = self.process_dir(self.gallery_dir, relabel=False) # [img_path, pid, camid, 'market1501', pid]
