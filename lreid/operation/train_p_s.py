...
def train_p_s_an_epoch(config, base, loader, current_step, old_model, old_graph_model, current_epoch=None, output_featuremaps=True):
    ...
    for _ in range(config.steps):
        ...
        if old_model is None:
            ...
            protos, protos_k, correlation = base.model_dict['metagraph'](features.detach())

            # feature_fuse = features + protos
            feature_fuse = features + protos_k
            ...
            del feature_maps, feature_fuse, features, protos, protos_k
        else:
            ...
            # the fusion of new knowledge and accumulated knpwledge
            feature_fuse = features + protos_k
