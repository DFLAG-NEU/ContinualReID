...
def main(config):
    ...
    if config.mode == 'train':  # train mode
        ...
        for current_step in range(start_train_step, loaders.total_step): 
            ...
            if current_step > 0: # train the first domain
...
if __name__ == '__main__':
    ...
    machine_dataset_path = '/home/lzs/ContinualReID/dataset'
    ...
    parser.add_argument('--steps', type=int, default=250, help='150 for 5s32p4k')
    ...
    parser.add_argument('--meta_graph_vertex_num', type=int, default=62,
